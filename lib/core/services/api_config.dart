class ApiConfig {
  ...
  static const String registerWithPhone = '$baseUrl/auth/register-with-phone';

  static const String resetPasswordWithPhone =
      '$baseUrl/auth/reset-password-with-phone';
